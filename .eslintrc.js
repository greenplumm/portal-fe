/*
 * @Author: your name
 * @Date: 2020-12-02 09:29:55
 * @LastEditTime: 2020-12-14 13:42:37
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /portal-fe/.eslintrc.js
 */
module.exports = {
  ...
  parserOptions: {
    ...
    ecmaVersion: 2020, // 支持es6以上语法，但并不意味着同时支持新的 ES6 全局变量或类型（比如 Set 等新类型）
  ...
  rules: {
    ...
    'func-call-spacing': 0, // 函数调用时，函数名与()之间不能有空格 当调用一个函数时，开发者是否可以在函数名和调用它的括号之间插入空格
    'comma-dangle': ['error', 'never'], // 是否允许对象中出现结尾逗号
    'no-cond-assign': 2, // 条件语句的条件中不允许出现赋值运算符
    'no-console': 0, // 是否允许出现console语句
